...
let logocaution = document.getElementById("logocaution")
...
button_next.addEventListener('click', () => {
    ...
    else if(slides[5].style.display=="block"){
   ...
   else if(slides[13].style.display=="block"){
	console.log("smoothie");
	slides[13].style.display="none";
	slides[2].style.display="block";
	button_next.style.display="none";
	button_repeat.style.display="block";
